...
<div class="container-fluid">
    ...
    <!-- Status Card -->
    <div class="card mb-4 border-<?= $statusClass[$payment['status']] ?>">
        <div class="card-body text-center py-4">
            <i class="fas fa-<?= $statusIcon[$payment['status']] ?> fa-4x text-<?= $statusClass[$payment['status']] ?> mb-3"></i>
            <h3 class="mb-0">Status: <?= $statusText[$payment['status']] ?></h3>
        </div>
    </div>
                    ...
                    <?php if ($payment['payment_proof']): ?>
                        ...
                        <?php if (in_array(strtolower($fileExt), ['jpg', 'jpeg', 'png'])): ?>
                            <div class="text-center">
                                <img src="<?= $filePath ?>" class="img-fluid rounded mb-3" alt="Bukti Pembayaran" style="max-height: 400px; cursor: pointer;" onclick="window.open('<?= $filePath ?>', '_blank')">
                                <div>
    ...
    <div class="text-center mt-4">
        ...
        <?php if ($payment['status'] == 'pending'): ?>
            <a href="<?= base_url('admin/payments/pending') ?>" class="btn btn-warning ms-2">
