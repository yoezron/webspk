...
<div class="row">
    <div class="col">
        <div class="page-description d-flex justify-content-between align-items-center">
            <div>
                <h1>Tambah Tarif Iuran Baru</h1>
                <span>Buat tarif iuran baru untuk anggota</span>
            </div>
            <div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url('admin/dues-rates/create') ?>">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="rate_type" name="rate_type" required>
                                <option value="monthly" <?= old('rate_type') === 'monthly' ? 'selected' : '' ?>>Bulanan</option>
                                <option value="yearly" <?= old('rate_type') === 'yearly' ? 'selected' : '' ?>>Tahunan</option>
                                <option value="one_time" <?= old('rate_type') === 'one_time' ? 'selected' : '' ?>>Sekali</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="member_category" name="member_category">
                                ...
                                <option value="candidate" <?= old('member_category') === 'candidate' ? 'selected' : '' ?>>Kandidat</option>
                                <option value="active" <?= old('member_category') === 'active' ? 'selected' : '' ?>>Aktif</option>
                            </select>
                            ...
                            <select class="form-select" id="region_code" name="region_code">
                                ...
                                <?php foreach ($regions as $region): ?>
                                    <option value="<?= esc($region['region_code']) ?>"
                                            <?= old('region_code') === $region['region_code'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control"
                                  ...
                                  name="description"
                                  rows="3"
                                  placeholder="Deskripsi atau catatan tentang tarif ini..."><?= old('description') ?></textarea>
                    </div>
